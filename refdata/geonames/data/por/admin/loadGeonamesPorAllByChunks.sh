...
# With one Shell:
MY_FIFO=/tmp/my-fifo-por-allCountries.txt
DATA_FILE=../../por/data/allCountries.txt
...
#
SQL_QUERY="set foreign_key_checks=0; set sql_log_bin=0; set unique_checks=0; LOAD DATA LOCAL INFILE '${MY_FIFO}' INTO TABLE geoname CHARACTER SET UTF8 (geonameid, name, asciiname, alternatenames, latitude, longitude, fclass, fcode, country, cc2, admin1, admin2, admin3, admin4, population, elevation, gtopo30, timezone, moddate)"
